...
// Hook this custom post type function into the them 
...
function starter_scripts() {
	//Styles
// 	wp_enqueue_style( 'starter-style', get_stylesheet_directory_uri() . '/style.css' ); 	

	//Scripts
	//wp_enqueue_script( 'jquery', get_stylesheet_directory_uri() . '/js/jquery.js', array(''));
	wp_enqueue_script( 'anchor', get_stylesheet_directory_uri() . '/js/anchor.js', array('jquery'), '20140602', false);
	
	wp_enqueue_script( 'mobile', get_stylesheet_directory_uri() . '/js/mobile.js', array('jquery'), '20140602', false);
